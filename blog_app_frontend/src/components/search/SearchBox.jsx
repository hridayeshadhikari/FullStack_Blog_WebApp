  ...
  return (
    <div className='bg-white mb-4'>
      ...
      <div className='flex p-4'>
        <input onChange={(e) => setInputData(e.target.value)} id='searchData' className='p-2 bg-gray-200 font-bold w-full md:w-auto rounded-l-md border-2 border-gray-300 outline-none focus:border-blue-500' type="search" placeholder='Search' />
